    ...
    <div className="relative w-full bg-white dark:bg-gray-800">
      <div className="flex justify-center items-center flex-wrap md:flex-nowrap flex-col-reverse sm:flex-row md:justify-between">
        <div className="flex flex-col justify-end md:py-16 lg:mb-20 items-start sm:w-[50%] w-full">
          ...
          <h1 className="sm:mt-1 xl:mt-15  text-[1.7rem] text-start font-bold tracking-tight text-black md:text-4xl lg:text-5xl dark:text-white sm:text-3xl mt-10 ">

            Hello! my name is{" "}
            <span className="text-sky-600 underline">Nouman Nawaz </span>{" "}
            & I am a 
          ...
          <p className="text-start text-black dark:text-gray-100  my-5 text-xl italic">
            " I help <strong>start-ups</strong> and <strong>companies</strong> to
            build beautiful and interactive <strong>web aplications.</strong> "
          </p>

       <div className="flex gap-x-2"> <Button />  <ButtonTwo /></div>
        </div>
