...
export default function Navbar() {
  return (
    <Disclosure
      as="nav"
      className="bg-white dark:bg-gray-800 rounded-md shadow-lg   sm:my-[20px] my-6 border-2 border-black/20 dark:border-white/20 fixed top-0 sm:left-[10%] z-50 sm:w-[calc(80%)] w-[90%] left[5%] "
    >
      {({ open }) => (
        <>
            ...
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-between">
                <div className="flex flex-shrink-0 items-center">
                  <NavLink
                    to=""
                    className="font-bold text-xl text-black dark:text-white flex items-center justify-between"
                  >
                    <svg
                      width="40"
                      height="46"
